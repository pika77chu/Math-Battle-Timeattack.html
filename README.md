# Math-Battle-Timeattack
Race against the clock and unleash powerful attacks by solving math problems! The faster and more accurate you are, the stronger your combo—and the bigger the damage. Can you conquer all foes and claim the ultimate high score?
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
function makeAnswer() {
let kigous = ["×","÷","+","-"];
let num = Math.min(difficult*2,4);
let answer = [];
let usednum = 0;
while (usednum < num) {
if (usednum === 0) {
...
problem++;
damageTimer = 30;
totalTime += (Math.min(20,10*difficult)-time4);
...
time4--;
if (time4 < 0) {
totalTime += Math.min(20,difficult*10);
mode = 7;
problem++;
damageTimer = 30;
unclear++;
